...
//Initial loading og the data from the Server
initDataSource() {
  this._appointmentService.getAllCompletedAppointment(0, 5).pipe(
  ...
  onPageChanged(event: PageEvent) {
    ...
    this._appointmentService.getAllCompletedAppointment(offset,limit).pipe(
